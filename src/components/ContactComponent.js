                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="lasstname" name="lastname" placeholder="Last Name" value={this.state.lastname} onChange={this.handleInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='textarea' id="message" name="message" value={this.state.message} rows='12' onChange={this.handleInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
